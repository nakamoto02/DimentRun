...
public class Tile3D : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        if (oneTimeSave == null)
        {
            oneTimeSave = new StageData {
                stageForward    = Vector3.forward,
                startPoint      = new Vector3(0, 0, 0),
                goalPoint       = new Vector3(0, 0, 0),
                respawnPoints   = new Vector3[] {new Vector3(0, 0, 0)},
                backLinesRight  = new Dimension.BackLine[] { new Dimension.BackLine()},
                backLinesLeft   = new Dimension.BackLine[] {new Dimension.BackLine()}
            };
        }
    ...
    public Mesh RenderMesh {
        get { return renderMeshBuilder.Mesh; }
    }
    public Mesh ColliderMesh {
        get { return colliderMeshBuilder.Mesh; }
    }
    ...
    //public bool IsLoad { get { return !isExecution && stageData != null && stageData.blocks.Length != 0; } }

    [HideInInspector] public string stageName;
    [HideInInspector] public StageData stageData;


    [HideInInspector] public StageData oneTimeSave;
